...
import MedicineExpiryStatement from "@/components/reports/MedicineExpiryStatement";
import { useGetMedicineExpiryStatementReportsQuery } from "@/redux/api/reports.api";
import { IFormValues } from "@/types";
import { formatDate } from "@/utils/formateDate";
import { useState } from "react";
import { Button, DatePicker, Form, Loader } from "rsuite";

const MedicineExpiryStatementPage = () => {
  ...
  const { data, isLoading, isFetching } =
    useGetMedicineExpiryStatementReportsQuery(queryParams, {
      skip: !isSearchEnable,
    });
...
export default MedicineExpiryStatementPage;
