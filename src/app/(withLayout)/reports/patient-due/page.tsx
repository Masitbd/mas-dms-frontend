...
import PatientDueReportsTable from "@/components/reports/PatientDueReports";
import { useGetPatientDueReportsQuery } from "@/redux/api/reports.api";
...
const PatientDuePage = () => {
  ...
  const { data, isLoading } = useGetPatientDueReportsQuery(queryParams, {
    skip: !isSearchEnable,
  });
  return (
    <div>
