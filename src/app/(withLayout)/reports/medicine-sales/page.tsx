...
import MedicineSalesTable from "@/components/reports/MedicineSalesTable";
import { useGetMedicinesSalesReportsQuery } from "@/redux/api/reports.api";
import { IFormValues } from "@/types";
import { useState } from "react";
import { Button, DatePicker, Form } from "rsuite";

const MedicineSalesReports = () => {
  ...
  const { data, isLoading } = useGetMedicinesSalesReportsQuery(queryParams);
...
export default MedicineSalesReports;
