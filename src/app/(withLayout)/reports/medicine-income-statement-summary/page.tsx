...
import MedicineIncomeStatementSummary from "@/components/reports/MedicineIncomeStatementSummary";
import { useGetMedicineIncomeStatementSummaryReportsQuery } from "@/redux/api/reports.api";
import { IFormValues } from "@/types";
import { formatDate } from "@/utils/formateDate";
import { useState } from "react";
import { Button, DatePicker, Form, Loader } from "rsuite";

const MedicineIncomeStatementSummaryPage = () => {
  ...
  const { data, isLoading, isFetching } =
    useGetMedicineIncomeStatementSummaryReportsQuery(queryParams, {
      skip: !isSearchEnable,
    });
    ...
    <div>
      ...
      <div className="px-2 my-5">
        ...
        {!isLoading && !isFetching && data?.data && (
          <MedicineIncomeStatementSummary
            data={data.data}
...
export default MedicineIncomeStatementSummaryPage;
